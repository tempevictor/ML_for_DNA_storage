...
basecalled_dir=$4  
# ****TO CHANGE path to store temporary data****
...
do
    ...
    python /vol/bitbucket/vt520/CATCaller_master/generate_dataset/inference_data_trim.py -fast5 ${fast5_path} -records_dir ${tmp_records_dir} -raw_len ${signal_window_length} -threads 40
    #*****************************************
